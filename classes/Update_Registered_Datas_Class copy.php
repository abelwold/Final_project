...
public function update_incident_reporter($document_no,$title, $first_name, $middel_name, $last_name, $phone, $address, $addressTwo, $city, $state, $zip_code)
    ...
    public function update_registeree($document_no,$rank,$identification_no, $first_name_registeree, $last_name_registeree, $incident_location, $nature_incident, $incident_details, $incident_motivated, $report_before, $arreseted)
    {
      


        // $sth = $this->db->prepare("SELECT * FROM   registeree   WHERE identification_no='$identification_no'");
        // $sth->execute();
