...
<div class="row">
  ...
  <div class="profile-info col-md-9">
          ...
          <!-- <footer class="panel-footer">
              <button class="btn btn-success pull-right">Print Document</button>
          </footer> -->
      ...
      <div class="panel">
          ...
          <a href="Manage_Registered_Data.php" class="btn btn-warning stretched-link">Go Back</a>
          </form>
          </div>
          <div class="panel-body bio-graph-info">
              ...
              <div class="row">
                ...
                <div class="bio-row">
                    <p><span>Date </span>: <b><?= $row['Date'] ?></b></p>
                </div>
              </div>
          </div>
      </div>
