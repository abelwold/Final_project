                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <h1>Manage Registered Police Officer <span class="table-project-n">Data</span></h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="police_id" data-editable="true">police_id </th>
                                                ...
                                                <th data-field="nationality" data-editable="true">nationality</th>
                                                ...
                                                <th data-field="photo" data-editable="false">photo</th>
                                                <th data-field="previously_registered_station" data-editable="true">previously_registered_station</th>
                                                <th data-field="currently_registered_station" data-editable="true">currently_registered_station</th>
                                                <th data-field="rank" data-editable="true">rank</th>
                                                <th data-field="position" data-editable="true">position</th>
                                                <th data-field="date_join_police" data-editable="true">date_join_police</th>
                                        ...
                                        $result = $students->index('register_police_officer');
                                        if($result)
                                        {$count=0;
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['phone']?></td>
                                                <td><?= $row['email'] ?></td>
                                                <td class="buttons"><?php if(file_exists($row['photo'])){
                                                    echo "<div class='card'>
                                                    <div class='card-body'>
                        ...
                        echo "<a href='#' class='btn btn-danger'>Not Available</a>";
                                                ...
                                                <td><?= $row['previously_registered_station'] ?></span></td>
                                                <td><?= $row['currently_registered_station'] ?></td>
                                                <td><?= $row['rank'] ?></td>
                                                <td><?= $row['position'] ?></td>
                                                <td><?= $row['date_join_police']?></td>
                                                <td class="buttons">
                                                <a href="View_Registred_New_Police_Officers.php?id=<?=$row['police_id'];?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                <a href="Edit_Registered_Police_Officers.php?id=<?=$row['police_id'];?>" class="btn btn-warning" title="Edit"> <i class="fa fa-pencil-square-o"></i></a>                                        
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-4 py-5 p-md-5">
                ...
                <form autocomplete="off" action="Delete_Data_Police_Officer.php?id=<?php echo $row['police_id']?>"
