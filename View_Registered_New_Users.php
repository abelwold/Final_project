                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Registered Assigned Users</h3>
                            <p class="text-subtitle text-muted">Only to View Detailes of Registered Assigned Users.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                ...
                                <p class="error"><?php echo @$register->error; ?></p>
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Registered Assigned Users</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="layout-content">
          ...
          <div class="container flex-grow-1 container-p-y">
            ...
            <div class="container-m-nx container-m-ny theme-bg-white mb-4">
              ...
              <a href="Download_Assigned_Users_Picture.php?id=<?=$row['photo']?>">
  <img src="<?= $row['photo']?>" alt="" class="d-block ui-w-100 rounded-circle">Download</a>
                <div class="media-body ml-5">
                  <h4 class="font-weight-bold mb-4"><?= $row['first_name'] ?><?= $row['last_name'] ?></h4>
                  ...
                  <a href="javascript:void(0)" class="d-inline-block text-body">
                    ...
                    <span class="text"><strong><?= $row['identification_no'] ?></strong></span>
                  </a>
                </div>
              </div>
              <hr class="m-0">
              ...
              <div class="col">
                ...
                <div class="card mb-4">
                  ...
                  <p>
                    ...
                    <div class="row mb-2">
                      <div class="col-md-3 text-muted">user_type:</div>
                      <div class="col-md-9">
                      <?= $row['user_type'] ?>
                      </div>
                    </div>
                    ...
                    <div class="row mb-2">
                      <div class="col-md-3 text-muted">auto_password:</div>
                      <div class="col-md-9">
                      <?= $row['auto_password'] ?>
                      </div>
                    </div>
