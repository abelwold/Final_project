...
include_once 'classes/Register_Crime_Class.php';
...
<button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    ...
    if((isset($_POST['submit'])))
    {
        ...
        $inputData = [
            ...
            'marital_status' => $db,$_POST['marital_status'],
            'resident_address' => $db,$_POST['resident_address'],
            'city' => $db,$_POST['city'],
            'state' => $db,$_POST['state'],
            'phone' => $db,$_POST['phone'],
            'Id_document_type' => $db,$_POST['Id_document_type'],
            'hight' => $db,$_POST['hight'],
            'weight' => $db,$_POST['weight'],
            'eye_color' => $db,$_POST['eye_color'],
            'hair_color' => $db,$_POST['hair_color'],
            'emergency_phone' => $db,$_POST['emergency_phone'],
            'date_of_court_appearance' => $db,$_POST['date_of_court_appearance'],
            'location_of_court' => $db,$_POST['location_of_court'],
            'Nature_of_offence' => $db,$_POST['Nature_of_offence'],
            'Investigating_off_first_name' => $db,$_POST['Investigating_off_first_name'],
            'Investigating_off_last_name' => $db,$_POST['Investigating_off_last_name'],
            'Investigating_off_id' => $db,$_POST['Investigating_off_id'],
            'date_of_offence' =>$db,$_POST['date_of_offence'],
            'location_of_offence' => $db,$_POST['location_of_offence'],
            
        ];
    
        $obj = new RegisterCrime;
        $result = $obj->upload_image_and_store($_POST,$_FILES,$inputData);
...
<div id="main">
    ...
    <div class="page-heading">
        <form class="form form-horizontal" autocomplete="off" action="" enctype="multipart/form-data" method="post">
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Register Suspect's</h3>
                        <p class="text-subtitle text-muted">To Register suspect, please provide the following
                            information's</p>
                    </div>
                    <p class="error"><?php echo @$obj->error; ?></p>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="Admin_Index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Register suspect</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" id=resident_address" class="form-control"
                                                    name="resident_address" placeholder="Address">
                                                <span class="error"
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="tel" id="phone" class="form-control" name="phone"
                                                    placeholder="Phone No" pattern="[0-9]{3}[0-9]{3}[0-9]{3}">
                                                <span class="error"
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="file" class="form-control" name="passport_photo"
                                                    id="passport_photo" placeholder="Passport Size Photo">
                                                <span class="error"
                                                    style="color: red;"><?php echo $passport_photo_error;?></span>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Signature Photo</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="file" name="signature_photo" id="signature_photo" value="/"
                                                    class="form-control" placeholder="Signature Photo">
                                                <span class="error"
                                                    style="color: red;"><?php echo $signature_photo_error;?></span>
                                            </div>
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="file" name="id_document_photo" id="id_document_photo"
                                                    class="form-control" placeholder="Identification Document">
                                                <span class="error"
                                                    style="color: red;"><?php echo $id_document_photo_error;?></span>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Height</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="number" id="hight" class="form-control" name="hight"
                                                    placeholder="Height">
                                                <span class="error"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-right">
                                                    <div class="position-relative">
                                                        <input type="date" name="date_of_court_appearance"
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <textarea class="form-control" name="Nature_of_offence"
                                                            id="Nature_of_offence" rows="29"></textarea>
                                                    </div>
                                                    <span class="error"
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="date" name="date_of_offence" class="form-control"
