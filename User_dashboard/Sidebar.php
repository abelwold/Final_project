                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="Manage_Registered_Data.php">List of Registered Data</a>
                                </li>
                                <li class="submenu-item ">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="Managed_registered_crime_data.php">List of Registered Suspect</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <!-- <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="Manage_Registerd_Police_Officers.php">List of Registered Officers</a>
                                </li>
                            </ul>
                        </li> -->
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="#">List of Registered Station</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="Manage_Registered_Users.php">List of Users</a>
                                </li>
                            </ul>
                        </li>
